    ...
    switch (Message) {
        case WM_CREATE:
            ...
            hStatic = CreateWindow("STATIC", "Please input two numbers",
                                   WS_CHILD | WS_VISIBLE, 20, 15, 175, 20,
                                   hwnd, NULL, NULL, NULL);
            ...
            CreateWindow("BUTTON", "+", WS_CHILD | WS_VISIBLE,
                         35, 100, 30, 20, hwnd, (HMENU)ID_BUTTON_ADD, NULL, NULL);


            CreateWindow("BUTTON", "-", WS_CHILD | WS_VISIBLE,
                         75, 100, 30, 20, hwnd, (HMENU)ID_BUTTON_SUB, NULL, NULL);


            CreateWindow("BUTTON", "*", WS_CHILD | WS_VISIBLE,
                         115, 100, 30, 20, hwnd, (HMENU)ID_BUTTON_MUL, NULL, NULL);


            CreateWindow("BUTTON", "/", WS_CHILD | WS_VISIBLE,
                         155, 100, 30, 20, hwnd, (HMENU)ID_BUTTON_DIV, NULL, NULL);
            break;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    wc.hbrBackground = CreateSolidBrush(RGB(300, 0, 100));
